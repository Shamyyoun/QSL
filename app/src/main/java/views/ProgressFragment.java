...
//    private ProgressView linearProgressView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        circularProgressView = (ProgressView) rootView.findViewById(R.id.circularProgressView);
        errorView = rootView.findViewById(R.id.view_error);
        emptyView = rootView.findViewById(R.id.view_empty);
//        linearProgressView = (ProgressView) rootView.findViewById(R.id.linearProgressView);
    ...
    */
    protected void showMain() {
        ...
        // hide circular progress view if it is visible
        ViewUtil.fadeView(circularProgressView, false);

        // hide linear progress view if it is visible
//        ViewUtil.fadeView(linearProgressView, false);
//        linearProgressView.stop();
    ...
    protected void showProgress() {
        ...
        if (viewState != VIEW_STATE_MAIN) {
            ...
            ViewUtil.fadeView(errorView, false);
            ViewUtil.fadeView(emptyView, false);
            // and show circular progress view
//            circularProgressView.start();
            ViewUtil.fadeView(circularProgressView, true);
            ...
            AppMsg.cancelAll(activity);
            // and show linear progress view
//            linearProgressView.start();
//            ViewUtil.fadeView(linearProgressView, true);
        }
    }
